...
public class Parser {
    ...
    private Node boolCompare() throws SyntaxErrorException {
        ...
        BooleanCompareNode.comparisonType comparisonType;
        if (matchAndRemove(Token.tokenType.LESSTHAN) != null)
            comparisonType = BooleanCompareNode.comparisonType.LESSTHAN;
        else if (matchAndRemove(Token.tokenType.GREATERTHAN) != null)
            comparisonType = BooleanCompareNode.comparisonType.GREATERTHAN;
        else if (matchAndRemove(Token.tokenType.GREATERTHANOREQUALTO) != null)
            comparisonType = BooleanCompareNode.comparisonType.GREATERTHANOREQUALTO;
        else if (matchAndRemove(Token.tokenType.LESSTHANOREQUALTO) != null)
            comparisonType = BooleanCompareNode.comparisonType.LESSTHANOREQUALTO;
