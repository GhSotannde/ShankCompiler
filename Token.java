public class Token {
    public enum tokenType { IDENTIFIER, NUMBER, ENDOFLINE, WHILE, DEFINE, ARRAY, OF, STRING, CONSTANTS, VARIABLES, INTEGER, FOR, FROM, TO,
                            ...
                            MINUS, DIVIDE, CLOSEPARENTHESES, OPENBRACKET, CLOSEBRACKET, OPENCURLYBRACE, CLOSECURLYBRACE, QUOTATION, SEMICOLON,
                            COLON, ASSIGNMENTEQUAL, LESSTHANOREQUALTO, NOTEQUAL, LESSTHAN, GREATERTHANOREQUALTO, GREATERTHAN, OPENPARENTHESES, 
