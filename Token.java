public class Token {
    public enum tokenType { IDENTIFIER, ENDOFLINE, WHILE, DEFINE, ARRAY, OF, STRING, CONSTANTS, VARIABLES, INTEGER, FOR, FROM, TO,
                            ...
                            MULTIPLY, STRINGLITERAL, CHARACTERLITERAL, INVALIDSYMBOL, UNTERMINATEDSTRING, SPACE, DEDENT, INDENT, TRUE, FALSE }
